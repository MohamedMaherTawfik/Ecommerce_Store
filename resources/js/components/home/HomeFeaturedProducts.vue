<template>
    <section ref="target" class="section-shell" :class="{ 'is-visible': inView }">
        <SectionTitle eyebrow="Curated" title="Featured products" description="Signature pieces selected to define the tone of the season.">
            <template #actions>
                <Button as="RouterLink" variant="secondary" :to="`/${lang}/products`">See all</Button>
            </template>
        </SectionTitle>
