<template>
    <section ref="target" class="section-shell" :class="{ 'is-visible': inView }">
        <SectionTitle eyebrow="Trending" title="Best sellers" description="The items customers return to for their fit, finish, and versatility.">
            <template #actions>
                <Button as="RouterLink" variant="secondary" :to="`/${lang}/products?sort=rating`">See all</Button>
            </template>
        </SectionTitle>
