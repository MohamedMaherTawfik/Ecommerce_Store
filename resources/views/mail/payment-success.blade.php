    ...
    <div
        ...
        <div style="padding:30px;color:#333;">
            ...
            <div style="background:#f9fafb;padding:15px;border-radius:10px;margin:20px 0;">
                <p style="margin:5px 0;"><strong>Amount Paid:</strong> {{ $order->currency ?? 'USD' }} {{ number_format((float) $order->total, 2) }}</p>
                <p style="margin:5px 0;"><strong>Payment Method:</strong> {{ strtoupper($order->payment_method ?? 'Online') }}</p>
            </div>
